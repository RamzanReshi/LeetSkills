...
const NAV_ITEMS = [
  ...
  { href: "/scenarios", key: "nav.scenarios", icon: BookIcon },
  { href: "/path", key: "nav.paths", icon: CompassIcon },
    ...
    <nav className={`h-full flex flex-col gap-1 transition-all duration-300 ${isCollapsed ? "items-center p-2" : "p-4"}`}>
      ...
      {onToggleCollapse && (
        ...
        >
          ...
          {!isCollapsed && <span className="text-xs font-medium">{t("nav.collapse")}</span>}
        </button>
      )}
              ...
              className={[
                ...
                active
                  ? isCollapsed
                    ...
                    : "border-l-2 border-brand-primary bg-brand-mint ps-[10px] text-brand-primary"
